...
const AddCategory = () => {
  ...
  const validateForm = () => {
    ...
    if (!description) formErrors.description = t("DescriptionRequired");
  ...
  const handleSave = () => {
    ...
    request
      .then(() => {
        toast.success(edit ? t("CategoryUpdated") : t("CategoryAdded"));
    ...
    <div className="mt-5">
      ...
      <div className="flex gap-5 px-2">
        ...
        <span className="text-3xl font-medium text-center text-four">
          {t("Category")} /{" "}
          <span className="text-one">{t(edit ? "Edit" : "Add")}</span>
        </span>
      </div>
