    ...
    <div className='flex flex-col p-4'>
      ...
      <div className='bg-seven w-full flex flex-col md:flex-row items-center md:items-start relative rounded-lg p-4 md:p-6'>
        ...
        <div className='flex flex-col text-center md:text-left'>
          <span className='text-2xl md:text-3xl font-medium text-one mb-2'>{data.name || "No Name"}</span>
          <span className='text-base text-one mb-3'>{data.email || "No Email"}</span>
        ...
        <button
          ...
          className='absolute top-3 right-3 text-one text-2xl hover:text-red-500'
        >
          <CiLogout />
        </button>
        ...
        <button
          ...
          className='absolute top-14 right-3 text-one text-2xl hover:text-yellow-500'
        >
          <FaUserEdit />
        </button>
      </div>
        ...
        <div className='bg-seven w-full rounded-lg p-5'>
          <div className='flex items-center gap-2 mb-4'>
            <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
              <path d="M13 0C5.81875 0 0 5.81875 0 13C0 20.1812 5.81875 26 13 26C20.1812 26 26 20.1812 26 13C26 5.81875 20.1812 0 13 0ZM12.7188 6.5C13.4125 6.5 13.9688 7.0625 13.9688 7.75C13.9688 8.4375 13.4062 9 12.7188 9C12.0312 9 11.4688 8.4375 11.4688 7.75C11.4688 7.0625 12.025 6.5 12.7188 6.5ZM15 19H11V18.5H12V11H11V10.5H14V18.5H15V19Z" fill="#876340" />
            </svg>
            <span className='text-xl font-medium text-one'>Personal Information</span>
          </div>

          <div className='flex flex-col gap-2'>
            <span className='text-lg text-one'>Phone Number: {data.phoneNumber || "No phone"}</span>
          </div>
        </div>
      </div>
    </div>
